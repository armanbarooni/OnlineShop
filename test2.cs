{
	...
	"WorkerCount": "5",
	"WorkerRefundInquiry__ConnectionString": "Server=crmlsn.hadb.asiatech.net;Database=OnlinePay;User ID=sqluser;Password=[)yv^/Y|^+a7cJBqMTV_;MultipleActiveResultSets=true; TrustServerCertificate=True;",
	"WorkerSqlServer__ConnectionString": "Server=crmlsn.hadb.asiatech.net;Database=Pay_Queue;User ID=sqluser;Password=[)yv^/Y|^+a7cJBqMTV_;MultipleActiveResultSets=true; TrustServerCertificate=True;"
}