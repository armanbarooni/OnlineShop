    ...
    public class SyncErrorLogProfile : Profile
    {
        public SyncErrorLogProfile()
        {
            ...
            CreateMap<CreateSyncErrorLogDto, SyncErrorLog>()
                ...
                .ForMember(d => d.StackTrace, opt => opt.Ignore())
                .ForMember(d => d.IsResolved, opt => opt.Ignore())
                .ForMember(d => d.ResolvedAt, opt => opt.Ignore())
                .ForMember(d => d.ResolvedBy, opt => opt.Ignore())
                .ForMember(d => d.ResolutionNotes, opt => opt.Ignore())
                .ForMember(d => d.OccurrenceCount, opt => opt.Ignore())
                .ForMember(d => d.LastOccurredAt, opt => opt.Ignore())
            ...
            CreateMap<UpdateSyncErrorLogDto, SyncErrorLog>()
                ...
                .ForMember(d => d.StackTrace, opt => opt.Ignore())
                .ForMember(d => d.RequestData, opt => opt.Ignore())
                .ForMember(d => d.ResponseData, opt => opt.Ignore())
                .ForMember(d => d.IsResolved, opt => opt.Ignore())
                .ForMember(d => d.ResolvedAt, opt => opt.Ignore())
                .ForMember(d => d.ResolvedBy, opt => opt.Ignore())
                .ForMember(d => d.ResolutionNotes, opt => opt.Ignore())
