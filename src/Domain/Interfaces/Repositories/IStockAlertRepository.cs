...
namespace OnlineShop.Domain.Interfaces.Repositories
{
    public interface IStockAlertRepository : IGenericRepository<StockAlert>
    {
        ...
        Task<List<StockAlert>> GetByUserIdAsync(string userId, CancellationToken cancellationToken = default);
        ...
        Task<bool> ExistsAsync(Guid productId, Guid? productVariantId, string userId, CancellationToken cancellationToken = default);
