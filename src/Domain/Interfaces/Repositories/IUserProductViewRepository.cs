...
namespace OnlineShop.Domain.Interfaces.Repositories
{
    public interface IUserProductViewRepository
    {
        ...
        Task<List<UserProductView>> GetByUserIdAsync(Guid userId, int limit = 20, CancellationToken cancellationToken = default);
        Task<List<UserProductView>> GetByProductIdAsync(Guid productId, CancellationToken cancellationToken = default);
        Task<List<UserProductView>> GetRecentlyViewedAsync(Guid userId, int limit = 20, CancellationToken cancellationToken = default);
        ...
        Task<List<UserProductView>> GetReturningViewsAsync(Guid userId, CancellationToken cancellationToken = default);
        ...
        Task<bool> HasUserViewedProductAsync(Guid userId, Guid productId, CancellationToken cancellationToken = default);
